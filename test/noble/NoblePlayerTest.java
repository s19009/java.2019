...
public class NoblePlayerTest{
    ...
    public static class receiveCardの動作確認 {
        ...
        @Test
        public void バラバラのカードを配る() throws Exception {
        ...
        @Test
        public void 何組か揃ったカードを配る() throws Exception {
        ...
        @Test
        public void 全て揃ったカードを配る() throws Exception {
            ...
            instance.receiveCard(new Card(Card.SUIT_HEART, 2));
            instance.receiveCard(new Card(Card.SUIT_DIAMOND, 3));
            instance.receiveCard(new Card(Card.SUIT_HEART, 1));
